  ...
  const fakeAxiosGetGroups = () => { //maybe this data is passed down already from the App page
    return ({
      groups: [{
        ...
        Photo: 'https://images.unsplash.com/photo-1529778873920-4da4926a72c2?ixlib=rb-1.2.1&ixid=MnwxM[…]8MHxzZWFyY2h8MXx8Y3V0ZSUyMGNhdHxlbnwwfHwwfHw%3D&w=1000&q=80',
        Friendliness: 3,
        Safety: 5,
        Privacy: false,
        Pending: [
